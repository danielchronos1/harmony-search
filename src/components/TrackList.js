...
const TrackList = ({ trackResults, handleTrackClick }) => {
  return (
    <div className="flex flex-col items-center">
      <h1 className="text-5xl font-bold mt-6 mb-6 tablet:text-xl small:text-xl">Search Results</h1>
      <div className="grid grid-cols-3 grid-rows-3 gap-4 tablet:grid-cols-1 small:grid-cols-1">
